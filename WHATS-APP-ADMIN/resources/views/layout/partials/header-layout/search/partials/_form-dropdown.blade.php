...
<form data-kt-search-element="form" class="w-100 position-relative mb-3" autocomplete="off">
    ...
    <span class="btn btn-flush btn-active-color-primary position-absolute top-50 end-0 translate-middle-y lh-0 d-none"
          data-kt-search-element="clear">{!! getSvgIcon('duotune/arrows/arr061.svg', 'svg-icon svg-icon-2 svg-icon-lg-1 me-0') !!}</span>
    <!--end::Reset-->
    <!--begin::Toolbar-->
    <div class="position-absolute top-50 end-0 translate-middle-y" data-kt-search-element="toolbar">
        ...
        <div data-kt-search-element="preferences-show" class="btn btn-icon w-20px btn-sm btn-active-color-primary me-1"
             ...
             title="Show search preferences">{!! getSvgIcon('duotune/coding/cod001.svg', 'svg-icon svg-icon-1') !!}</div>
        <!--end::Preferences toggle-->
        <!--begin::Advanced search toggle-->
        <div data-kt-search-element="advanced-options-form-show"
             class="btn btn-icon w-20px btn-sm btn-active-color-primary" data-bs-toggle="tooltip"
             title="Show more search options">{!! getSvgIcon('duotune/arrows/arr072.svg', 'svg-icon svg-icon-2') !!}</div>
