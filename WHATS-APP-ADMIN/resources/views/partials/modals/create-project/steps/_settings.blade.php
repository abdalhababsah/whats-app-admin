    ...
    <div class="w-100">
        ...
        <div class="fv-row mb-8">
            ...
            <label class="d-flex align-items-center fs-6 fw-semibold form-label mb-2">
                ...
                <i class="fad fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip"
        ...
        <!--begin::Actions-->
        <div class="d-flex flex-stack">
            <button type="button" class="btn btn-lg btn-light me-3" data-kt-element="settings-previous">Project Type
            </button>
